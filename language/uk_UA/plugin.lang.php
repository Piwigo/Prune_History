...
$lang['PH_AutoPrune_title_d'] = 'Якщо ви включили автоматичне очищення, воно буде запускатися автоматично при кожному вході користувача в галерею (включаючи адміністратора або веб-майстера) на основі збережених налаштувань.<br><br>
<b style=&quot;color: red;&quot;>Використовуйте з обережністю! Очищені дані не можна буде відновити!</b>';
$lang['PH_ManualPrune_title_d'] = 'Ця функція дозволяє видалити записи історії на основі діапазону дат. Виберіть дату початку та дату завершення очищення і запускайте.<br><br><b style=&quot;color: red;&quot;>Попередження: дані журналу будуть  безповоротньо видалені!</b> Ви можете створити резервну копію і відновити таблицю історії за допомогою функції в правильному кутку екрана.<br><br>Примітка: Історія резюме не постраждає від очищення.';
$lang['PH_Save_Title_d'] = 'Оскільки очищення є остаточним і незворотним, бажано зберегти вашу таблицю історії перед початком очищення. За замовчуванням таблиця зберігається у файлі на сервері і може бути відновлена звідти.<br><br> Але також можна завантажити файл резервної копії, щоб отримати його на ваш комп\'ютер. У цьому випадку відновлення повинно бути зроблено через ваш інструмент управління бази даних (зазвичай phpMyAdmin).';
$lang['PH_Support'] = 'Офіційна підтримка плаґіну, тільки в цій темі форуму Piwigo:<br>
...
$lang['PH_Restore'] = 'Відновіть вашу резервну копію таблиці історії.<br>Враховується тільки файл збережений на сервері.';
...
$lang['PH_Dump_Download'] = 'Відмітьте це поле, щоб завантажити файл резервної копії:';
